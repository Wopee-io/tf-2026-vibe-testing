# Team 4 · Coding agent + Playwright MCP
...
- **Skill:** `.github/skills/team-4-my-skill/` — run it with `run team-4-my-skill`

## Checklist

- [ ] Folder in `teams/team-4/`, pull request open (a draft is fine)
...
| `SKILL.md` | The starting point for your skill. `team-setup` moves it to `.github/skills/team-4-my-skill/SKILL.md` at the repository root, where your agent finds it; by hand, move it there and set `name` to `team-4-my-skill` |
